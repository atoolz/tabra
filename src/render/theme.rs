...
impl Default for Theme {
    fn default() -> Self {
        Self {
            popup_bg: Color::Rgb { r: 30, g: 30, b: 46 },       // dark surface
            text_fg: Color::Rgb { r: 205, g: 214, b: 244 },     // light text
            selected_bg: Color::Rgb { r: 69, g: 71, b: 90 },    // subtle highlight
            match_fg: Color::Rgb { r: 137, g: 180, b: 250 },    // blue accent
            desc_fg: Color::Rgb { r: 127, g: 132, b: 156 },     // muted
            kind_fg: Color::Rgb { r: 166, g: 227, b: 161 },     // green
            danger_fg: Color::Rgb { r: 243, g: 139, b: 168 },   // red
            border_fg: Color::Rgb { r: 88, g: 91, b: 112 },     // border
        }
    }
}
